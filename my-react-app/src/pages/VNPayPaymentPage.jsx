...
export default function VNPayPaymentPage() {
  ...
  const handlePayment = () => {
    ...
    // Giả lập redirect đến VNPAY
    setTimeout(() => {
      // Trong thực tế, đây sẽ là redirect đến VNPAY gateway
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="flex items-center justify-center mb-6">
                <div className="bg-[#E5E7EB] rounded-lg p-4">
                  <div className="text-[24px] font-bold text-[#2563EB]">VNPAY</div>
                </div>
              </div>
              ...
              <div className="space-y-4 mb-6">
                <div className="bg-[#F9FAFB] rounded-lg p-4">
                  ...
                  <ul className="text-[13px] text-[#6B7280] space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Nhấn nút "Thanh toán" bên dưới để chuyển đến cổng thanh toán VNPAY</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#DC2626]">2.</span>
                      <span>Chọn ngân hàng của bạn và đăng nhập</span>
                    </li>
                    <li className="flex items-start gap-2">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-[#DC2626]">4.</span>
                ...
                <div className="border border-[#E5E7EB] rounded-lg p-4">
                  ...
                  <div className="text-[12px] text-[#6B7280] mt-2">
                    Hỗ trợ tất cả các ngân hàng nội địa Việt Nam
                  </div>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full py-3 bg-[#2563EB] text-white rounded-lg font-medium hover:bg-[#1D4ED8] transition-colors disabled:bg-[#D1D5DB] disabled:cursor-not-allowed"
              >
