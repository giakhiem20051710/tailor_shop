...
public interface WorkingSlotRepository extends JpaRepository<WorkingSlotEntity, Long> {
       ...
       // Used for listing all slots for a staff member (active and inactive)
       Page<WorkingSlotEntity> findByStaffId(Long staffId, Pageable pageable);

       Page<WorkingSlotEntity> findByIsActiveTrue(Pageable pageable);

       Page<WorkingSlotEntity> findByDayOfWeekAndIsActiveTrue(DayOfWeek dayOfWeek, Pageable pageable);

       // Used for validation to check if a slot already exists for staff on that day
       Page<WorkingSlotEntity> findByStaffIdAndDayOfWeekAndIsActiveTrue(Long staffId, DayOfWeek dayOfWeek,
                     Pageable pageable);
