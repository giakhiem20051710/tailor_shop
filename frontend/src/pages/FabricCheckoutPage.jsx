...
import PointsRedemptionWidget from "../components/PointsRedemptionWidget.jsx";
...
export default function FabricCheckoutPage() {
  ...
  const finalTotal = Math.max(0, subtotal - discount - pointsDiscount + shippingFee);
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg border border-[#E5E7EB] p-4 sticky top-[190px]">
                ...
                <PointsRedemptionWidget
                  orderTotal={Math.max(0, subtotal - discount + shippingFee)}
                  onApply={({ pointsUsed, discountAmount }) => {
                    setPointsUsed(pointsUsed || 0);
                    setPointsDiscount(discountAmount || 0);
                  }}
                />
                    ...
                    {pointsDiscount > 0 && (
                      <div className="flex justify-between">
                        <span className="text-[#6B7280]">
                          Giảm từ xu ({pointsUsed?.toLocaleString()} xu):
                        </span>
