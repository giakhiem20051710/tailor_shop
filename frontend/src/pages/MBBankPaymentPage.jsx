...
export default function MBBankPaymentPage() {
  ...
  // SEO Meta Tags
  usePageMeta({
    title: "Thanh toán MB Bank | My Hiền Tailor",
    description: "Thanh toán đơn hàng vải may đo qua MB Bank. Chuyển khoản nhanh chóng và tiện lợi qua ngân hàng MB Bank.",
  });
  ...
  const handlePayment = () => {
    ...
    // Giả lập redirect đến MBBank
    setTimeout(() => {
      alert("Đang chuyển hướng đến cổng thanh toán MBBank...");
      // window.location.href = mbbankUrl;
    }, 1000);
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="flex items-center justify-center mb-6">
                <div className="bg-[#C41E3A] text-white rounded-lg px-6 py-4">
                  <div className="text-[20px] font-bold">MBBank</div>
                  <div className="text-[12px] opacity-90">Ngân hàng Quân đội</div>
                </div>
              </div>
              ...
              <div className="space-y-4 mb-6">
                <div className="bg-[#F9FAFB] rounded-lg p-4">
                  ...
                  <ul className="text-[13px] text-[#6B7280] space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="text-[#C41E3A]">1.</span>
                      <span>Nhấn nút "Thanh toán" để chuyển đến cổng thanh toán MBBank</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#C41E3A]">2.</span>
                      <span>Đăng nhập tài khoản MBBank của bạn</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#C41E3A]">3.</span>
                      <span>Xác nhận thông tin thanh toán và hoàn tất giao dịch</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#C41E3A]">4.</span>
                ...
                <div className="bg-[#FEF2F2] border border-[#FECACA] rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-[13px] font-semibold text-[#111827]">Ưu đãi đặc biệt</span>
                  </div>
                  <p className="text-[12px] text-[#6B7280]">
                    Thanh toán qua MBBank được giảm thêm 1% trên tổng đơn hàng
                  </p>
                </div>
                ...
                <div className="border border-[#E5E7EB] rounded-lg p-4">
                  ...
                  <div className="text-[12px] text-[#6B7280] mt-2">
                    Chỉ dành cho khách hàng có tài khoản MBBank
                  </div>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full py-3 bg-[#C41E3A] text-white rounded-lg font-medium hover:bg-[#A01A2F] transition-colors disabled:bg-[#D1D5DB] disabled:cursor-not-allowed"
              >
                {isProcessing ? "Đang xử lý..." : "Thanh toán qua MBBank"}
              </button>
            </div>
