...
-- Version: V17
-- Description: Tạo bảng products với product_key và product_type (tránh reserved words)

CREATE TABLE IF NOT EXISTS products (
  id BIGINT AUTO_INCREMENT PRIMARY KEY,
  product_key VARCHAR(100) NOT NULL UNIQUE COMMENT 'Unique key cho product (ví dụ: ao-dai-do-500k)',
  ...
  product_type VARCHAR(50) NULL COMMENT 'Loại sản phẩm (ví dụ: collection, newArrival)',
